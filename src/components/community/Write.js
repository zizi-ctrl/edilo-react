...
const Write = () => {
    return(
        <FlexDiv padding='70px 0 0 0' align='column-center'>
            ...
            <Textarea width='60%' contentEditable='true' border='none' padding='36px 12px'></Textarea>
            <FlexDiv width='900px' justifyContent='right' padding='36px 0 72px' borderTop='1px solid #E1E4E6'>
