...
const Profile = () => {
    return (
        <FlexDiv borderRadius='30px' width='80%' height='180px' margin='30px 0' backgroundColor='white' justifyContent='space-around' align='row-vertical-center'>
            <FlexDiv padding='0 0 0 6%' boxSizing='border-box' width='50%' align='row-vertical-center' borderRight='4px dotted #E1E4E6'>
                ...
                <Div margin='0 20px' fontSize='24px'>여행가132</Div>
            </FlexDiv>
